...
public class DTOFactoryTest extends TestCase {
	...
	protected void setUp() throws Exception {
		super.setUp();
		 ...
		 GenericDAO<User,Long> daoUser = new GenericDAOImp<User, Long>(User.class);
		 GenericDAO<Topic,Long>daoTopic = new GenericDAOImp<Topic, Long>(Topic.class);
		...
		this.idea = ideaDao.read(idea.getIdeaiId()); 
	...
	private boolean compareIdeaDTOandEntity(IdeaDTO ideaDto){
		...
		if (ideaDto.getTitle()!=null && ideaDto.getTitle().equals(this.idea.getTitle())){
			cont++;
			System.out.println("title ok");
		}
		
		if (ideaDto.getDescription() != null && ideaDto.getDescription().equals(this.idea.getDescription())){
			cont++;
		...
		if(ideaDto.getIdeaComments() != null && ideaDto.getIdeaComments().size() == idea.getIdeaComments().size()){
			cont++;
			System.out.println("ideaComment ok");
		}
		
		if(ideaDto.getVotes() !=null && ideaDto.getVotes().size() == idea.getVotes().size()){
			cont++;
